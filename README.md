...
> <p>I created, managed and deployed the website and mobile app for Joystick. I created the website with PHP Laravel and ReactJS, and I created the mobile app with ReactJS Native. I received an outstanding reference for this role. At Joystick the website and mobile app needed to have the same look and feel as the Joystick logo. The website and mobile app for Joystick have translation support for English and Spanish.</p>
