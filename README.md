...
> <p>I created and managed the mobile app for PlayPal in 2024 with ReactJS Native, and the website with PHP Laravel and ReactJS. At PlayPal the website and mobile app needed to have the same look and feel as the PlayPal logo. I was responsible for design, delivery and deployment of these platforms. The website and mobile app for PlayPal had translation support for English and Spanish.</p>
