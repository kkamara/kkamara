...
Favourite music: I pay for Spotify. The most important benefit is no ads. There are also great features like genre and artist stations, and autoplay, which is when similar music continues playing after your playlist ends. Amazon Music also has these features. Otherwise, there are ambient sounds, offline music, and radios on [The Kelvin Kamara Sound App](https://www.github.com/kkamara/the-kelvin-kamara-sound-app) which is free to download. Sometimes I listen to radios (usually SmoothFM), or music on YouTube.
